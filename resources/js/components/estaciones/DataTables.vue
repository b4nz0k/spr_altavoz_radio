<template>
    ...
    <script>
    import CargandoData from '../utils/CargandoData.vue';
    ...
    data: () => ({
        ...
        // dialog: false,
        rutas: {
            urlGet:'estaciones/list',
            urlSearch:'estaciones/search?page=',
            urlStore: 'estaciones/add',
            urlUpdate: 'estaciones/update',
            urlDelete: 'estaciones/delete/',
        },
        dialogDelete: false,
        headers: [
          { text: 'ID', value: 'id' }, //id
          { text: 'Estacion', align: 'start', sortable: false, value: 'estacion',  },
...
/*         dialogDelete: {
      ...
      async created () {
        console.log('Iniciando componente Categorias')
        await this.cambiarRutas(this.rutas)
        await this.cargarTablas(1)
      },
      mounted() {
