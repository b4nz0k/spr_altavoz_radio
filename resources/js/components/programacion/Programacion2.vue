...
-->
                            ...
                            <v-card-text>
                                ...
                                <v-row>
                                    <v-col cols="12">
                                        {{vmodel_podcast}}
                                    <v-autocomplete
                                        v-model="vmodel_podcast"
                                        :items="podcastList" item-text="titulo"
                                        item-value="id" placeholder="Podcast"
    ...
    export default {
        data: () => ({
            today: new Date().toISOString().substr(0,9),
            focus: new Date().toISOString().substr(0,9),
            type: "week",
            // typeToLabel: {
            //     month: "Mes",
            //     week: "Semana",
            ...
            events: [
               {
                    name: 'Evento 1',
                    start: '2022-09-12 09:00',
                    end: '2022-09-12 10:00'
                },
            ],
            // Diego Teck
            name: null,
    ...
    /*             const time = this.getCurrentTime();
            ...
            async cargarEvents() {
                try {
                    await axios.get('programacion/lista').then(res => {
