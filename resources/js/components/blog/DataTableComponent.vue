...
export default {
    ...
    methods: {
        ...
        publicados() {
            ...
            axios.get('blog/list/all').then(response => {
                ...
                axios.post('system/logs', {
                    ...
                    file: 'components\\blog\\DataTableComponent.vue'
                }).catch(error => {});
            });
        },
        ...
        borradores() {
            //this.setDessertsPrograma([]);
            axios.get('blog/list/trash').then(response => {
                if (!response.data.answer) {
                    this.setDesserts(response.data);
                    this.$store.dispatch('countBlog');
                    this.loading = false;
        ...
        papelera() {
            //this.setDessertsPrograma([]);
            axios.get('blog/list/remove').then(response => {
                if (!response.data.answer) {
                    this.setDesserts(response.data);
                    this.$store.dispatch('countBlog');
                    this.loading = false;
