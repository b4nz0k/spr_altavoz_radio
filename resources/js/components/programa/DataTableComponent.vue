    ...
    methods: {
        ...
        confirmarPapeleraItem(item, accion) {
            axios.post('programa/records', {
                ...
                if (records > 0) {
                    this.$store.dispatch('dialogConfirmacionDelete', ['Confirmación', 'Existen ' + records + ' podcast adjuntas a este programa ¿Está seguro de que desea enviar a papelera ' + item.titulo + '?', true]);
                } else {
        ...
        confirmarPermanenteItem(item, accion) {
            axios.post('programa/records', {
                ...
                let records = response.data;
                if (records > 0) {
                    this.$store.dispatch('dialogConfirmacionDelete', ['Confirmación', 'Existen ' + records + ' podcast adjuntas a este programa ¿Está seguro de que desea borrar permanantemente a ' + item.titulo + '?', true]);
                } else {
